...
public class DocumentController {
    ...
    public ResponseEntity<ApiResponseDto<DocumentResponseDto>> uploadDocument(
        ...
        DocumentResponseDto response = documentService.uploadDocument(file);
    ...
    @GetMapping
    @Operation(summary = "List all documents", description = "Retrieve a list of all uploaded documents")
